        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3">
                  {user?.role === 'admin' ? (
                    <img src="./src/assets/Media.jpg" alt="Pofile" class="w-auto h-12 object-contain"/>
                  ) : (
                    <img src="https://www.inlifemagazine.com/wp-content/uploads/2015/12/R.jpg" alt="Profile" class="w-auto h-12 object-contain"/>
                  )}
                <div>
